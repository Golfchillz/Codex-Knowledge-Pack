...
- สิ่งใดเสร็จแล้ว
- สิ่งใดกำลังดำเนินการ
- สิ่งใดได้รับอนุมัติ
- สิ่งใดยังไม่ได้รับอนุญาต
- งานถัดไปคืออะไร
...
`Golfchillz/Codex-Knowledge-Pack`
...
> One Workspace. One Truth. One Current Project State.
